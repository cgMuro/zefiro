    ...
    return (
        <Container className="my-5" id="about-container">
            <div className="mt-3 d-flex flex-column justify-content-center align-items-center">
                ...
                <img src="https://images.pexels.com/photos/3808904/pexels-photo-3808904.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=1260" alt="about-us" className="img-fluid p-3 my-3 w-75"/>
                <p className="mx-5">
                    Our redaction:
